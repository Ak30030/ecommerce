...
.then((response) => {setPaymentSummary(response.data);
    ...
    return (
      ...
      <div className="header-content">
        ...
        <div className="checkout-header-middle-section">
          Checkout (<Link to="/"
            className="return-to-home-link">3 items</Link>)
        </div>
  ...
  <div key={cartItem.productId} className="cart-item-container">
              <div className="delivery-date">
                Delivery date: {selectedDeliveryOption ? dayjs(selectedDeliveryOption.
                  estimatedDeliveryTimeMs).format('dddd, MMMM D') : 'Not selected'}
              </div>
